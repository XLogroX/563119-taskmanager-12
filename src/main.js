...
render(controlContainer, createMenuTemplate(), `beforeend`);
...
render(board, createCardsContainerTemplate(), `beforeend`);

const cardsContainer = board.querySelector(`.board__tasks`);
render(cardsContainer, createCardEditTemplate(), `beforeend`);
